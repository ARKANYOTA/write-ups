...
def intro():
    ...
    print(E.PK)
    print("Je vous rappelle que les requêtes à l'oracle de signature sont limitées à 10 par sessions pour éviter le flood, la version complète (avec un nombre de requête beaucoup plus important) arrivera après ces tests")
    print("Merci de me faire part de tous les problèmes que vous pourrez trouver! Et ne faites pas attention à la partie debug.")
