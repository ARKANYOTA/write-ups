...
```
Ceci est un tutoriel à destination des débutants qui ne connaîtraient pas netcat. Tout d'abord, nous vous conseillons d'avoir accès à un environnement linux, ou à minima une machine virtuelle ou encore WSL.
